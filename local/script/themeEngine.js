...
function themeSwitch(themeToSwitch) {
  ...
  if (themeToSwitch === 'srcery') {
    logo.style.filter, nav.style.filter = 'invert(25%) sepia(90%) saturate(2606%) hue-rotate(322deg) brightness(91%) contrast(70%)';
    ...
    logo.style.filter, nav.style.filter = 'invert(9%) sepia(92%) saturate(6219%) hue-rotate(330deg) brightness(75%) contrast(100%)';
    ...
    logo.style.filter, nav.style.filter = 'invert(13%) sepia(49%) saturate(7396%) hue-rotate(334deg) brightness(68%) contrast(91%)';
    footer[0].style.backgroundImage = 'none';
    ...
    logo.style.filter, nav.style.filter = 'invert(17%) sepia(82%) saturate(5371%) hue-rotate(336deg) brightness(97%) contrast(112%)';
    footer[0].style.backgroundImage = 'url(/highRES/local/footer-background.svg)';
    icon.style.filter = 'invert(55%) sepia(0%) saturate(81%) hue-rotate(199deg) brightness(91%) contrast(85%)';

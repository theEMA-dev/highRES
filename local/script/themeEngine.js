...
function themeSwitch(themeToSwitch) {
  ...
  if (themeToSwitch === 'srcery') {
    logo.style.filter = 'invert(25%) sepia(90%) saturate(2606%) hue-rotate(322deg) brightness(91%) contrast(70%)';
    ...
    logo.style.filter = 'invert(13%) sepia(49%) saturate(7396%) hue-rotate(334deg) brightness(68%) contrast(91%)';
    footer[0].style.backgroundImage = 'none';
